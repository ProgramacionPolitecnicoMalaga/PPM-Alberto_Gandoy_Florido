...
public class InterfazJuego {
    ...
    public String pedirNombreNuevoRobot(){
        System.out.println("Por favor, indique el nombre del nuevo robot :");
    ...
    public int pedirMovimientoParaRobot(String nombreRobot){
        ...
        do {
            System.out.println("Elija un movimiento para " + nombreRobot + "\n" +
                    ...
                    Movimiento.HACIA_DIAGONAL_ARRIBA_DERECHA + ". en diagonal hacia arriba a la derecha\n" +
                    Movimiento.HACIA_DIAGONAL_ARRIBA_IZQUIERDA + ". en diagonal hacia arriba a la izquierda\n" +
                    Movimiento.HACIA_DIAGONAL_ABAJO_DERECHA + ". en diagonal hacia abajo a la derecha\n" +
                    Movimiento.HACIA_DIAGONAL_ABAJO_IZQUIERDA + ". en diagonal hacia abajo a la izquierda");
            movimiento = pedirEntero("Elija una opción: ");
            if ((movimiento < 1) || (movimiento > 8))
                System.out.println("El movimiento elegido debe estar entre 1 y 8. Por favor, vuelva a introducir valores válidos");
